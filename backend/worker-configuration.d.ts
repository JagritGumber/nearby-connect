/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b370a05cf78926ae2bfb1a43987dca7b)
// Runtime types generated with workerd@1.20250924.0 2025-09-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatRoomDurableObject" | "PresenceDurableObject";
	}
	interface Env {
		...
		APP_URL: string;
		JWT_SECRET: string;
		DO_CHAT_ROOM: DurableObjectNamespace<import("./src/index").ChatRoomDurableObject>;
		DO_PRESENCE: DurableObjectNamespace<import("./src/index").PresenceDurableObject>;
		R2_STORAGE: R2Bucket;
		ASSETS: Fetcher;
	}
}
