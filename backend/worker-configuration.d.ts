/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 74e4dd5673e4f0de30770ab6bc1bd7b2)
// Runtime types generated with workerd@1.20250924.0 2025-09-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionManager" | "WebSocketManager" | "LocationTracker" | "ChatRoomDurableObject" | "PresenceDurableObject";
	}
	interface Env {
		...
		APP_URL: string;
		JWT_SECRET: string;
		DO_SESSION: DurableObjectNamespace /* SessionManager */;
		DO_WEBSOCKET: DurableObjectNamespace /* WebSocketManager */;
		DO_LOCATION: DurableObjectNamespace /* LocationTracker */;
		DO_CHAT_ROOM: DurableObjectNamespace /* ChatRoomDurableObject */;
		DO_PRESENCE: DurableObjectNamespace /* PresenceDurableObject */;
		R2_STORAGE: R2Bucket;
		ASSETS: Fetcher;
	}
}
